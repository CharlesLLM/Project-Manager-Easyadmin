...
final class Version20240215101243 extends AbstractMigration
{
    ...
    {
        return 'Add project, category, technology and file tables with relationships between them';
    }
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE file (id INT AUTO_INCREMENT NOT NULL, stored_name VARCHAR(255) NOT NULL, original_name VARCHAR(255) NOT NULL, extension VARCHAR(5) NOT NULL, path VARCHAR(255) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE `utf8_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE project (id INT AUTO_INCREMENT NOT NULL, category_id INT NOT NULL, thumbnail_id INT DEFAULT NULL, name VARCHAR(50) NOT NULL, description LONGTEXT NOT NULL, link VARCHAR(255) DEFAULT NULL, start_date DATETIME NOT NULL, end_date DATETIME DEFAULT NULL, created_at DATETIME NOT NULL, updated_at DATETIME NOT NULL, INDEX IDX_2FB3D0EE12469DE2 (category_id), UNIQUE INDEX UNIQ_2FB3D0EEFDFF2E92 (thumbnail_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE `utf8_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE project ADD CONSTRAINT FK_2FB3D0EEFDFF2E92 FOREIGN KEY (thumbnail_id) REFERENCES file (id)');
